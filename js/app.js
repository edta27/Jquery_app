$(document).ready(function() {
  ...
  $('#addHome').click(function(evt){
    ...
    var newRow =  '<tr><td>' + home.address + '</td><td>' + home.sf + '</td><td>' + home.bedrooms + '</td>' +
                  '<td>' + home.baths + '</td><td>' + home.price + '</td><td>' +
                  '<button class="btn btn-xs btn-danger">Remove</button></td></tr>';
